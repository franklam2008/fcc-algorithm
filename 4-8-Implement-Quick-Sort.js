...
for(var i=1;i<arr.length;i++){
  for(var j=0;j<newarr.length;j++){
    if(arr[i]<newarr[0]||arr[i]===newarr[0]){
      newarr.unshift(arr[i]);
      break;
    }else if(arr[i]>newarr[j]&&arr[i]<newarr[j+1]||arr[i]===newarr[j]){
...
// test array:
quickSort([1, 4, 2, 8, 345, 123, 43, 32, 5643, 63, 123, 43, 2, 55, 1, 234, 92])// test array:
